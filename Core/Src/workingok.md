...
#define AUDIO_BUFFER_SIZE (8192)  // Stereo samples per second
#define HALF_BUFFER_SIZE (AUDIO_BUFFER_SIZE/2)
int16_t samples[AUDIO_BUFFER_SIZE];    // Buffer for stereo audio

uint32_t fread_size = 0;
uint32_t recording_size = 0;
uint32_t played_size = 0;

cb_res_t cb_res = UNKNOWN;

// Callbacks ///////////////////////////////////////////////////////////////////
void HAL_I2S_TxHalfCpltCallback(I2S_HandleTypeDef *hi2s)
{
	cb_res = HALF_COMPLETED;
}

void HAL_I2S_TxCpltCallback(I2S_HandleTypeDef *hi2s)
{
	cb_res = FULL_COMPLETED;
